from facedetection.hikvision import get_signature, get_headers, get_card_id, get_device_id, change_authority
import pandas as pd
import uuid
import requests
import time
...
# change_door_access("测试卡1", "0691796502", "SY2-1F-011", 2, 0)
